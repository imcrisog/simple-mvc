<div class="bg-zinc-900 p-10 h-screen flex justify-center md:justify-end items-center text-white w-full">
    ...
    <div>
        <form class="w-full flex flex-wrap justify-center gap-4" action="<?= LOCALHOST ?>/login" method="post">
            ...
            <button class="w-full py-2 hover:bg-indigo-800 font-semibold bg-indigo-700 rounded-md uppercase" type="submit"> LOGIN </button>
            <a class="text-indigo-500 underline underline-offset-2" href="<?= LOCALHOST ?>/register"> Register </a>
        </form>
    </div>
